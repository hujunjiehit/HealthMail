...
public class ShowResultAdapter2 extends BaseAdapter {
  private Context mContext;
  private List<BmobObject> mAcountList;

  public ShowResultAdapter2(Context mContext, List<BmobObject> mAcountList) {
  ...
  public View getView(final int position, View convertView, ViewGroup parent) {
    ViewHolder holder;
    if(convertView == null) {
      convertView = LayoutInflater.from(mContext).inflate(R.layout.item_show_result_2,parent,false);
      ...
      holder.tvSijiaoName = (TextView) convertView.findViewById(R.id.tv_sijiao_name);
    ...
    if(TextUtils.isEmpty(acountInfo.getSijiaoName())) {
      holder.tvSijiaoName.setText("");
    } else {
      holder.tvSijiaoName.setText(acountInfo.getSijiaoName() + "");
    }
    return convertView;
  }
