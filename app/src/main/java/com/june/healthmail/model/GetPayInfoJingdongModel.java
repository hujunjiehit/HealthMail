...
public class GetPayInfoJingdongModel {

    private int errmsg;
    private boolean succeed;
    private String MsgTime;
    private PayinfoJingdongDetail valuse;
    ...
    public PayinfoJingdongDetail getValuse() {
        return valuse;
    }

    public void setValuse(PayinfoJingdongDetail valuse) {
        this.valuse = valuse;
    }
