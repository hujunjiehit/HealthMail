...
public class GetPayInfoKuaijieModel {
    private int errmsg;
    private boolean succeed;
    private String MsgTime;
    private PayinfoKuaijieDetail valuse;
    ...
    public PayinfoKuaijieDetail getValuse() {
        return valuse;
    }

    public void setValuse(PayinfoKuaijieDetail valuse) {
        this.valuse = valuse;
    }
