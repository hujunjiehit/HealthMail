...
public class GetPayInfoLianlianModel {

    private int errmsg;
    private boolean succeed;
    private String MsgTime;
    private PayinfoLianlianDetail valuse;
    ...
    public PayinfoLianlianDetail getValuse() {
        return valuse;
    }

    public void setValuse(PayinfoLianlianDetail valuse) {
        this.valuse = valuse;
    }
