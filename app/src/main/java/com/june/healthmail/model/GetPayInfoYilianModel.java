...
public class GetPayInfoYilianModel {

    private int errmsg;
    private boolean succeed;
    private String MsgTime;
    private PayinfoYilianDetail valuse;
    ...
    public PayinfoYilianDetail getValuse() {
        return valuse;
    }

    public void setValuse(PayinfoYilianDetail valuse) {
        this.valuse = valuse;
    }
