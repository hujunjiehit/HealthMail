...
public class GetPayInfoYinshengbaoModel {

    private int errmsg;
    private boolean succeed;
    private String MsgTime;
    private PayinfoYinshengbaoDetail valuse;
    ...
    public PayinfoYinshengbaoDetail getValuse() {
        return valuse;
    }

    public void setValuse(PayinfoYinshengbaoDetail valuse) {
        this.valuse = valuse;
    }
