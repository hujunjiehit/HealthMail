...
public class DBManager {
    ...
    public void resetPJYKTimes(AccountInfo accountInfo){
        getDb().execSQL("update account set pingjiaTimes = ? , yuekeTimes = ?, sijiaoName = ? where phoneNumber = ?",
            new String[]{accountInfo.getPingjiaTimes()+"", accountInfo.getYuekeTimes()+"", accountInfo.getSijiaoName(), accountInfo.getPhoneNumber() });
    }
