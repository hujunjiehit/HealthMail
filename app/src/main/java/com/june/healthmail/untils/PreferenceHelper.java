...
public class PreferenceHelper extends BasePerference{
    ...
    public final static String KEY_SIJIAO_LIST= "sijiao_list";//私教列表
    ...
    public List<SijiaoInfo> getSijiaoList() {
        List<SijiaoInfo> list = null;
        checkPrefs();
        if (prefs != null) {
            String json = prefs.getString(KEY_SIJIAO_LIST, null);
            if (json != null) {
                list = gson.fromJson(json,new TypeToken<List<SijiaoInfo>>(){}.getType());
            }
        }
        return list;
    }
    ...
    public void setSijiaoList(List<SijiaoInfo> list) {
        ...
        if (prefs != null) {
            SharedPreferences.Editor editor = prefs.edit();
            if (list == null) {
                editor.putString(KEY_SIJIAO_LIST, null);
            } else {
                String str = gson.toJson(list);
                editor.putString(KEY_SIJIAO_LIST, str);
            }
            editor.apply();
        }
    }
