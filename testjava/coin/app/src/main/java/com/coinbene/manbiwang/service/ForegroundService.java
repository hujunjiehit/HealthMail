...
public class ForegroundService extends Service {
	...
	public void onCreate() {
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
			NotificationChannel channel = new NotificationChannel("coinbene", "coinbene",
			...
			Notification notification = new NotificationCompat.Builder(this, "coinbene").setAutoCancel(true).setCategory(
