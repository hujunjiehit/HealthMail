...
public class OrderBookAsksItemBinder extends ItemViewBinder<OrderModel, OrderBookAsksItemBinder.ViewHolder> {
	...
	public OrderBookAsksItemBinder(boolean isBuy, int greenColor, int redColor, boolean isRedRise, int amountTextColor, int contractType) {
		this.isBuy = isBuy;
	...
	public OrderBookAsksItemBinder(boolean isBuy, int greenColor, int redColor, boolean isRedRise, int amountTextColor) {
		this.isBuy = isBuy;
		this.greenColor = greenColor;
		this.redColor = redColor;
		this.isRedRise = isRedRise;
	...
	protected ViewHolder onCreateViewHolder(@NonNull LayoutInflater inflater, @NonNull ViewGroup parent) {
		View root = inflater.inflate(R.layout.kline_item_order_book_asks, parent, false);
	...
	static class ViewHolder extends RecyclerView.ViewHolder {
		...
		ViewHolder(View view, OrderBookAsksItemBinder binder) {
			super(view);
