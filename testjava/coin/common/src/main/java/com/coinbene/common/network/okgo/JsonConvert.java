...
//                BaseRes simpleResponse = Convert.fromJson(jsonReader, BaseRes.class);
//                response.close();
//                //noinspection unchecked
...
//                response.close();
//                String code = lzyResponse.exeStatus;
//                //这里的0是以下意思
...
//                    throw new IllegalStateException("错误代码：" + code + "，错误信息：" + lzyResponse.exeStatus);
////                }
//                }
//            }
//        }
