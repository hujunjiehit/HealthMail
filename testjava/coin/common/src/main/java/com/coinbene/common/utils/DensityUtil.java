...
public class DensityUtil {
    ...
    private static WindowManager getWindowManager() {
        if (windowManager == null) {
            windowManager = (WindowManager) CBRepository.getContext().getSystemService(Context.WINDOW_SERVICE);
        }
    ...
    public static int dip2px( float dpValue) {
        final float scale = CBRepository.getContext().getResources().getDisplayMetrics().density;
    ...
    public static int px2sp( float pxValue) {
        final float fontScale = CBRepository.getContext().getResources().getDisplayMetrics().scaledDensity;
