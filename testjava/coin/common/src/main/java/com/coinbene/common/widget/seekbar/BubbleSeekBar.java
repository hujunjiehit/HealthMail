package com.coinbene.common.widget.seekbar;
...
import static com.coinbene.common.widget.seekbar.BubbleSeekBar.TextPosition.BELOW_SECTION_MARK;
import static com.coinbene.common.widget.seekbar.BubbleSeekBar.TextPosition.BOTTOM_SIDES;
import static com.coinbene.common.widget.seekbar.BubbleSeekBar.TextPosition.SIDES;
import static com.coinbene.common.widget.seekbar.BubbleUtils.dp2px;
import static com.coinbene.common.widget.seekbar.BubbleUtils.sp2px;
...
public class BubbleSeekBar extends View {
    ...
    private final boolean isShowTopProgress;
    ...
    private OnProgressChangedListener mProgressListener; // progress changing initListener
    ...
    public BubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        isShowTopProgress = a.getBoolean(R.styleable.BubbleSeekBar_bsb_show_top_progress, false);
...
//        setMeasuredDimension();
        ...
        height += mTextSpace * 2;
        setMeasuredDimension(resolveSize(dp2px(180), widthMeasureSpec) + dp2px( 8), height + dp2px( 4));
...
//                    mPaint.setStyle(Paint.Style.FILL);
                ...
                // sectionMark
//                mPaint.setColor(getResources().getColor(R.color.green_4baf50));

                if (x_ <= junction) {
//                    mPaint.setStyle(Paint.Style.STROKE);
                    canvas.drawCircle(x_, yTop, dp2px(5), mPaint);
                    mPaint.setColor(getResources().getColor(R.color.color_seekBar_ring));
                    canvas.drawCircle(x_, yTop, dp2px(3), mPaint);
                } else {
//                    mPaint.setStyle(Paint.Style.FILL);
                    canvas.drawCircle(x_, yTop, dp2px(5), mPaint);
                }
        ...
        //外环颜色
        mPaint.setColor(getResources().getColor(R.color.color_seekBar_ring));
//        mPaint.setShadowLayer( mThumbRadius + 14,2,2,R.color.gray_font_bottom_color);
//        canvas.drawCircle(mThumbCenterX, yTop, isThumbOnDragging ? mThumbRadiusOnDragging : mThumbRadius + 10, mPaint);
        canvas.drawCircle(mThumbCenterX, yTop, mThumbRadius + 10, mPaint);
...
//        canvas.drawCircle(mThumbCenterX, yTop, isThumbOnDragging ? mThumbRadiusOnDragging : mThumbRadius, mPaint);
    ...
    /**
     * When BubbleSeekBar's parent view is scrollable, must initListener to it's scrolling and call this
