package com.coinbene.common.widget.tablayout;
...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
	...
	public void notifyDataSetChanged() {
		...
		for (int i = 0; i < mTabCount; i++) {
			tabView = View.inflate(mContext, R.layout.common_layout_tab, null);
	...
	public void addNewTab(String title) {
		View tabView = View.inflate(mContext, R.layout.common_layout_tab, null);
		if (mTitles != null) {
			mTitles.add(title);
		}
