...
import com.coinbene.manbiwang.contract.adapter.ContractPlanAdapter;
 ...
 * on 2019-09-09
 */
public class ContractPlanBtcFragment extends CoinbeneBaseFragment implements ContractRefreshInterface {
	...
	public static ContractPlanBtcFragment newInstance() {

		Bundle args = new Bundle();

		ContractPlanBtcFragment fragment = new ContractPlanBtcFragment();
	...
	public void getPlanOrderList() {
		...
		OkGo.<ContractPlanModel>get(Constants.CONTRACT_PLAN_ORDER_LIST).params(params).tag(this).execute(new NewJsonSubCallBack<ContractPlanModel>() {
			@Override
	...
	public void cancelPlanOrder(String planId) {
		...
		OkGo.<BaseRes>post(Constants.CONTRACT_CANCEL_PLAN_ORDER).params(params).tag(this).execute(new NewJsonSubCallBack<BaseRes>() {
			@Override
