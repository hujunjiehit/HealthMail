 ...
 * @author huyong
 */
public class ContractBtcChangePopWindow implements View.OnClickListener, ContractChangePopWindow {
	 ...
	 */
	public ContractBtcChangePopWindow(View anchor, boolean useKline) {
		mAnchor = anchor;
	...
	public void showBelowAnchor() {
		...
		NewMarketWebsocket.getInstance().registerMarketDataListener(contractQouteListener, MarketType.BTC_CONTRACT);
	}
	...
	public void onDismiss() {
		...
		NewMarketWebsocket.getInstance().unregisterMarketDataListener(contractQouteListener, MarketType.BTC_CONTRACT);
	}
