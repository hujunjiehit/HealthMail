 ...
 * 止盈止损 adapter
 */
public class ContractUsdtPlanAdapter extends BaseQuickAdapter<ContractPlanModel.DataBean.ListBean, BaseViewHolder> {
	...
	public ContractUsdtPlanAdapter() {
	...
	public BaseViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
		...
		contractUnit = parent.getResources().getString(R.string.trade_vol);
	...
	protected void convert(@NonNull BaseViewHolder helper, ContractPlanModel.DataBean.ListBean item) {
		...
		helper.setText(R.id.current_delegation_type, TradeUtils.getContractUsdtUnitValue(item.getQuantity(), table));
