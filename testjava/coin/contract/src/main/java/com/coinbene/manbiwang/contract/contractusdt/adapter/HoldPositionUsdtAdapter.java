...
public class HoldPositionUsdtAdapter extends BaseQuickAdapter<ContractPositionListModel.DataBean, BaseViewHolder> {
	...
	public HoldPositionUsdtAdapter() {
		super(R.layout.item_hold_position_usdt);
	}
