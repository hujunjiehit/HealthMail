...
public class ContractUsdtTopLayout extends LinearLayout implements View.OnClickListener {
...
//    TextView tvEstimateForcePriceValue;
	...
	@BindView(R2.id.iv_change_model)
	 ...
	 * 当前全逐仓模式
	 */
	String marginMode = MODE_CROSSED;
	String mMode;
	...
	public ContractUsdtTopLayout(Context context) {
		super(context);
	}

	public ContractUsdtTopLayout(Context context, @Nullable AttributeSet attrs) {
		super(context, attrs);
	}

	public ContractUsdtTopLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
	...
	private void initView() {
		ivChangeModel.setVisibility(GONE);
	}
	...
	public void onClick(View v) {
		...
		} else if (id == R.id.ll_model) {//				if (!CommonUtil.isLoginAndUnLocked()) {
//					UtilsApp.goToPopLoginActivity(getContext());
//					return;
//				}
//
//				showChangeModelDialog();
		} else if (id == R.id.tv_position_model) {//				if (!CommonUtil.isLoginAndUnLocked()) {
//					UtilsApp.goToPopLoginActivity(getContext());
//					return;
//				}
//				showChangeModelDialog();
	...
	private void doTransFer() {
		...
		//AccountTransferActivity.startActivity(getContext());
...
//			marginMode = modeSetting.equals(MODE_CROSSED) ? MODE_CROSSED : MODE_FIXED;
//			tvPositionModel.setText(marginMode.equals(MODE_FIXED) ? getContext().getString(R.string.gradually_position) : getContext().getString(R.string.crossed_position));
//		}
	}
...
//		DLog.d(TAG, "BailMode:" + marginMode);
	}
}
