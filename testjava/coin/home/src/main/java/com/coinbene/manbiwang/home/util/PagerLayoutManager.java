...
public class PagerLayoutManager extends RecyclerView.LayoutManager
	 ...
	 * @param columns 列数
	 */
	public PagerLayoutManager(@IntRange(from = 1, to = 100) int rows,
...
//		DLog.i(TAG,"Item onLayoutChildren");
//		DLog.i(TAG,"Item onLayoutChildren isPreLayout = " + state.isPreLayout());
//		DLog.i(TAG,"Item onLayoutChildren isMeasuring = " + state.isMeasuring());
//		DLog.e(TAG,"Item onLayoutChildren state = " + state);
...
//		DLog.i(TAG,"mOffsetX = " + mOffsetX);
//		DLog.i(TAG,"mOffsetY = " + mOffsetY);
...
//		DLog.e(TAG,"startPos = " + startPos);
//		DLog.e(TAG,"stopPos = " + stopPos);
...
//		DLog.e(TAG,"child count = " + getChildCount());
	}
...
//		DLog.e(TAG,"mTargetOffsetXBy = " + mTargetOffsetXBy);
//		DLog.e(TAG,"mTargetOffsetYBy = " + mTargetOffsetYBy);
