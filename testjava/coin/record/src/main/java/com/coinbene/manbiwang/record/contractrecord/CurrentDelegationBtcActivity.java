 ...
 * 合约当前委托
 */
public class CurrentDelegationBtcActivity extends CoinbeneBaseActivity {
	...
	public static void startMe(Context context) {
		Intent intent = new Intent(context, CurrentDelegationBtcActivity.class);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
			getSupportFragmentManager().beginTransaction()
					.add(R.id.fragment_container, CurrentOrderBtcFragment.newInstance())
					.commit();
		}
	}
