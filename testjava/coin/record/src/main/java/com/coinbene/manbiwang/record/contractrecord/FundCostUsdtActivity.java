...
import com.coinbene.manbiwang.record.contractrecord.adapter.UsdtFundCostAdapter;
 ...
 * 资金费用
 */
public class FundCostUsdtActivity extends CoinbeneBaseActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private int size = 10;
    private UsdtFundCostAdapter adapter;

    public static void startMe(Context context) {
        Intent intent = new Intent(context, FundCostUsdtActivity.class);
    ...
    public void init() {
        ...
        adapter = new UsdtFundCostAdapter();
        adapter.setContractType(Constants.CONTRACT_TYPE_USDT);
    ...
    private void getFundCost() {
        ...
        OkGo.<FundCostModel>get(Constants.FUND_COST_USDT).tag(this).params(params).execute(new NewJsonSubCallBack<FundCostModel>() {
            @Override
