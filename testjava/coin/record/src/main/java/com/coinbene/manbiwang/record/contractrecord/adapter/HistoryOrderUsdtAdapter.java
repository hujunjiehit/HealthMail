 ...
 * 合约历史委托适配器
 */
public class HistoryOrderUsdtAdapter extends BaseQuickAdapter<HistoryDelegationModel.DataBean.ListBean, BaseViewHolder> {
	...
	public HistoryOrderUsdtAdapter() {
		super(R.layout.record_item_history_delegation_usdt);
	}
