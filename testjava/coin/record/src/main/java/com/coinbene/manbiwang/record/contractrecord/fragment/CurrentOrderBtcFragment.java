...
import com.coinbene.manbiwang.record.contractrecord.adapter.CurrentOrderAdapter;
 ...
 * 合约当前委托 Fragment
 */
public class CurrentOrderBtcFragment extends CoinbeneBaseFragment implements ContractRefreshInterface {
	...
	public static CurrentOrderBtcFragment newInstance() {
		Bundle args = new Bundle();
		CurrentOrderBtcFragment fragment = new CurrentOrderBtcFragment();
	...
	public void cancelOrder(String orderId, int position) {
		...
		OkGo.<ContractPlaceOrderModel>post(Constants.TRADE_CANCEL_ORDER).tag(this).params("orderId", orderId).execute(new DialogCallback<ContractPlaceOrderModel>(getActivity()) {
			@Override
