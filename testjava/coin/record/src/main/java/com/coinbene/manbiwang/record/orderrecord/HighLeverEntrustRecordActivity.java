...
import com.coinbene.manbiwang.record.orderrecord.fragment.HighLeverEntrustFragment;
...
public class HighLeverEntrustRecordActivity extends CoinbeneBaseActivity {
	...
	public static void startMe(Context context) {
		Intent intent = new Intent(context, HighLeverEntrustRecordActivity.class);
	...
	public int initLayout() {
		return R.layout.record_trade_high_lever;
	}

	@Override
	public void initView() {
		titleView.setText(getText(R.string.high_lever_order));
	...
	private void showHistoryFragment() {
		...
		currentFrag = Fragment.instantiate(this, HighLeverEntrustFragment.class.getName(), bundle);
		ft.add(R.id.context_layout, currentFrag, HighLeverEntrustFragment.class.getName());
