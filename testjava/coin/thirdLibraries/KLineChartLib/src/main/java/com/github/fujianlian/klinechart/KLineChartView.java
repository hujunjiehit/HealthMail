	...
	private void initAttrs(AttributeSet attrs) {
		...
		if (array != null) {
			try {
				...
				setTextColor(getContext().getResources().getColor(R.color.chart_white));
				setDefaultTextColor(getContext().getResources().getColor(R.color.chart_y_text));
//				setDefaultTextSize(array.getDimension(R.styleable.KLineChartView_kc_text_size, getDimension(R.dimen.chart_text_size)))
				...
				setSelectedXLineColor(getColor(R.color.chart_selector));
				setSelectedXLineWidth(getDimension(R.dimen.chart_line_zero_five));

				setSelectedYLineColor(getColor(R.color.chart_selector));
				setSelectedYLineWidth(getDimension(R.dimen.chart_line_zero_five));

				setGridLineWidth(array.getDimension(R.styleable.KLineChartView_kc_grid_line_width, getDimension(R.dimen.chart_line_zero_five)));
				setGridLineColor(array.getColor(R.styleable.KLineChartView_kc_grid_line_color, getColor(R.color.chart_grid_line)));
				//macd
				setMACDWidth(array.getDimension(R.styleable.KLineChartView_kc_macd_width, getDimension(R.dimen.chart_candle_line_width)));
	...
	public void setRedRise(boolean redRise) {
		super.setRedRise(redRise);
		mMACDDraw.updateRedRise(redRise);
		mVolumeDraw.updateRedRise(redRise);
	}
}
