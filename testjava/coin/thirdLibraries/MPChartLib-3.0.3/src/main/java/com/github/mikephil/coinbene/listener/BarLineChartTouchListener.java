package com.github.mikephil.coinbene.listener;
...
import com.github.mikephil.coinbene.charts.HorizontalBarChart;
            ...
            if (totalDist > mMinScalePointerDistance) {
                ...
                if (mTouchMode == PINCH_ZOOM) {
                    ...
                    if (canZoomMoreX) {
                        ...
                        if (mChart instanceof CombinedChart && ((CombinedChart) mChart).getDataSize() <= 20) {
                            //数据小于20时，避免往左滑动，导致k线看不见的bug
