...
import mpchart.com.coinbene.patternlocker.model.CellFactoryIndicator;
import mpchart.com.coinbene.patternlocker.model.Config;
...
public class PatternIndicatorView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.cellBeanList == null) {
            this.cellBeanList = new CellFactoryIndicator(getWidth() - getPaddingLeft() - getPaddingRight(),
