...
import com.coinbene.manbiwang.model.http.SelectorLanguageItem;
...
public class LanguageSelectorBinder extends ItemViewBinder<SelectorLanguageItem, LanguageSelectorBinder.ViewHolder> {

    public LanguageSelectorBinder() {
    ...
    @Override
    protected void onBindViewHolder(@NonNull LanguageSelectorBinder.ViewHolder holder, @NonNull SelectorLanguageItem item) {
        ...
        holder.rootView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < adapterItems.size(); i++) {
                    SelectorLanguageItem item1 = (SelectorLanguageItem) adapterItems.get(i);
